...
-- This script is open-source, this is the official SHADOWS HUB page made by Troll
...
local LoadingConfig = {
    Duration = 8,
    FadeOutTime = 1.5,
    BarColor = Color3.fromRGB(255, 50, 50),     -- Vermelho
    BarGlow = Color3.fromRGB(255, 100, 100),    -- Vermelho brilhante
...
local function CreateStarParticle(parent, x, y)
    ...
    star.Parent = parent
    star.BackgroundColor3 = Color3.fromRGB(255, 50, 50)
...
local function CreateLoadingScreen()
    ...
    DotsLabel.Text = ""
    DotsLabel.TextColor3 = Color3.fromRGB(255, 50, 50)
...
local function StartLoadingSequence()
    ...
    local function updateProgress()
        ...
        local percentTween = TweenService:Create(
            ...
            {TextColor3 = Color3.fromRGB(255 + (percentage*0), 0 + (percentage*0), 0 + (percentage*0))}
        )
        percentTween:Play()
...
local Libary = loadstring(game:HttpGet("https://raw.githubusercontent.com/japones97281aaa/Redzmagnusv5/refs/heads/main/RedzV5.Lua.txt"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "🎩 Shad0ws Hub 🎩 | Brookhaven RP 🏡",
    SubTitle = "by: こんにちはラウンドまたもっと1つ時間ンン",
    LoadText = "SHADOWS HUB",
    Flags = "ShadowsHub_brookhaven"
})
...
InfoTab:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/KKthyRFx",
})
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "TikTok thzin0x" })
InfoTab:AddParagraph({ "Colaborações:", "Troll, Thurr, Linux Hub" })
InfoTab:AddParagraph({ "Você está usando:", "SHADOWS HUB" })
...
-- Botão para Cartola Hub 
UniversalTab:AddButton({
    Name = "Cartola Hub",
    Callback = function()
        loadstring(game:HttpGet("https://pandadevelopment.net/virtual/file/024662d77ba14c23"))()
    end
})

-- Botão para Furia Hub
UniversalTab:AddButton({
    Name = "Fúria Hub",
    Callback = function()
...
local ImunesTab = Window:MakeTab({"Proteções e Imunidades", "shield"})

-- Seção para Proteções e Imunidades
local ImunesSection = ImunesTab:AddSection({
    Name = "Proteções e Imunidades"
})
...
ImunesTab:AddToggle({
    ...
    Description = "Remove canoas de outros players automaticamente",
    Default = false,
